...
namespace DesktopApplication.Forms
{
    public partial class FormCategories : Form
    {
        ...
        /// <summary>
        /// method to create new Category form
        /// </summary>
        ...
        /// <summary>
        /// method to save Category data in db 
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        /// function to save categiry data in db, we will call it in btnSave function 
        /// </summary>
        ...
        /// <summary>
        ///  method to show the first Category in user form
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        ///  method to show the previous Category in user form
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        ///  method to show the next Category in user form
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        ///  method to show the last Category in user form
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
