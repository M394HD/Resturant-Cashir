...
namespace DesktopApplication.Forms
{
    public partial class FormPayments : Form
    {
        ...
        {
            adapter = new SqlDataAdapter("Select * From Payments", adoClass.sqlCn);
        ...
        /// <summary>
        /// method to create new Payments form
        /// </summary>
        ...
        /// <summary>
        /// method to save Payments data in db 
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        /// function to save Payments data in db, we will call it in btnSave function 
        /// </summary>
        ...
        /// <summary>
        ///  method to show the first Payments in user form
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        ///  method to show the previous Payments in user form
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        ///  method to show the next Payments in user form
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        ///  method to show the last Payments in user form
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        {
            FormSelect select = new FormSelect("select id, DES from Payments");
            select.des = "DES";
